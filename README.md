# :honey_pot: Honey Spam Power Toy for Magento 2 by [JaJuMa](https://www.jajuma.de/)

<img align="right" width="35%" height="auto" src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/JaJuMa-Honey-Spam-Power-Toy-For-Magento-2-small.png">  

Honey Spam Power Toy for Magento 2 by [JaJuMa](https://www.jajuma.de/en) is a dashboard toy 
display how much spam was detected and blocked in last X hours in your Magento store by [Honey Spam Anti-Spam](https://www.jajuma.de/en/jajuma-develop/extensions/honey-spam-anti-spam-extension-for-magento-2).
...
This Dashboard Toy provides:
* Stats how much spam was detected and blocked in last X hours in your Magento store
...
<td>
    <table>
     <tr>
        <td><b>Honey Spam Power Toy</b><br>Dark Mode</td>
        <td><b>Honey Spam Power Toy</b><br>Light Mode</td>
     </tr>
     <tr>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-for-magento-2/screenshots/Magento-Honey-Spam-Power-Toy-Dark.jpg"></td>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-for-magento-2/screenshots/Magento-Honey-Spam-Power-Toy-Light.jpg"></td>
    </tr>
    </table>
</td>
...
```
composer require jajuma/pot-honeyspam
```

## Using Honey Spam Power Toy For Magento

After installing this module:  
Go to   
**JaJuMa -> Power Toys -> Configuration**  
and enable & configure Honey Spam Toy.  
...
displaying the Honey Spam Toy.

* [See Manual for more details](https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-for-magento-2/manuals/JaJuMa_Honey_Spam_Power_Toy_Manual_v001.pdf)


## License

The code is licensed under the [MIT License (MIT)](https://github.com/JaJuMa/pot-honey-spam/blob/master/LICENSE)
